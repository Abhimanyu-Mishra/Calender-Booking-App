...
const BookingForm: React.FC<BookingFormProps> = ({ open, onClose, date, timeSlot, room, onBookingSuccess }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-start justify-center bg-black bg-opacity-40 transition-opacity animate-fadeIn p-4">
      <div className="relative w-full max-w-md mx-auto bg-white rounded-2xl shadow-2xl mt-8 mb-8 max-h-[calc(100vh-4rem)] overflow-y-auto animate-fadeInUp">
        <div className="sticky top-0 bg-white rounded-t-2xl px-8 pt-8 pb-4 border-b border-gray-100">
          <button
